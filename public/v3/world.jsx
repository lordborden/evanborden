...
(function () {
  ...
  const R1 = window.V3Rooms1;
  const R2 = window.V3Rooms2;
      ...
      <div className="v3-hud">
        <div className="v3-topbar">
          ...
          <div className="v3-versions">
            ...
            <span className="cur" title="v3 — Field Map (you are here)">v3</span>
            <a href="/" title="v4 — Executive Brief (current)">v4</a>
          </div>
        </div>
