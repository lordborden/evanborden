...
function V2Shell({ active, setActive }) {
...
function V2Sidebar({ active, setActive }) {
...
function V2Status({ active }) {
  const file = FILES.find(f => f.id === active) || FILES[0];
  const [time, setTime] = useS1("");
  useE1(() => {
    const tick = () => {
...
// PANE HEAD helper
// ============================================================
function PaneHead({ path, file, lang, keyHint }) {
  return (
    ...
    <section id="pane-hero">
      ...
      <div className="v2-pane">
        <div className="v2-hero">
          <div>
            ...
            <dl className="v2-metalist">
              <dt>role</dt>
              <dd>
                Manager, Engineering <span className="tag">@ Razorfish</span>
              </dd>
              <dt>tenure</dt>
        ...
        <div className="v2-boot">
          ...
          <div><span className="ts">[00:00.014]</span> <span className="ok">OK</span> &nbsp;mounted /career &mdash; 18 years</div>
          <div><span className="ts">[00:00.027]</span> <span className="ok">OK</span> &nbsp;loaded skills.tsv &mdash; 35 entries</div>
          <div><span className="ts">[00:00.041]</span> <span className="ok">OK</span> &nbsp;connected projects/ &mdash; 4 repos</div>
      ...
      <div className="v2-pane">
        ...
        <div className="v2-jsonl">
          <div className="bar">
            ...
            <span className="lang">{D.experience.length} records</span>
          </div>
...
window.V2Parts1 = { V2Shell, V2Sidebar, V2Status, V2Hero, V2Readme, V2Experience, PaneHead };
